        ...
        <div className={styles.container}>
          <div className={styles.headerContent}>
            <div className={styles.logo}>
              ...
              <span className={styles.brandName}>InternMatch</span>
            </div>
            <div className={styles.navButtons}>
              <button onClick={() => navigate('/login')} className={styles.btnSecondary}>Login</button>
              <button onClick={() => navigate('/register')} className={styles.btnPrimary}>Register</button>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className={styles.mainSection}>
        <div className={styles.hero}>
          <h1 className={styles.heroTitle}>
            Find Internships That
            <span className={styles.highlight}>Match Your Skills</span>
          </h1>
          <p className={styles.heroDescription}>
            Discover personalized internship opportunities based on your skills, CGPA, and interests. 
            Connect with top companies and kickstart your career journey.
          </p>
          <button onClick={() => navigate('/register')} className={`${styles.btnPrimary} ${styles.large}`}>
            <span>Get Started</span>
        ...
        <div className={styles.features}>
          {[
            { icon: Star, title: 'Personalized Matching', desc: 'Our AI-powered system matches you with internships based on your skills and preferences.' },
            { icon: Users, title: 'Top Companies', desc: 'Connect with leading companies looking for talented interns like you.' },
            { icon: TrendingUp, title: 'Career Growth', desc: 'Build your professional network and gain valuable industry experience.' },
          ].map(({ icon: Icon, title, desc }, index) => (
            <div key={index} className={styles.featureCard}>
              <div className={styles.iconContainer}><Icon className={styles.iconLarge} /></div>
